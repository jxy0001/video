...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="http://localhost:8080/video/static/bootstrap.css">
    <link rel="stylesheet" href="http://localhost:8080/video/static/profile.css">
    <link rel="stylesheet" href="http://localhost:8080/video/static/jquery.css">
            ...
            <div class="proflle_tab_body">
                <div class="proflle_tab_workplace clearfix">
                    ...
                    <div class="profile_ifo_area">
                        <form id="upload_form" action="updateHeadLogo" enctype="multipart/form-data" method="post">
                            <!-- hidden crop params -->
                            <input name="id" type="hidden" value="${user.id}">


                            <p>第一步：请选择图像文件</p>
                            <div><input class="btn btn-default btn-lg" name="uploadFile" id="image_file" onchange="fileSelectHandler()" type="file"></div>
...
<script src="http://localhost:8080/video/static/Jcrop_upload.js"></script>
</body></html>