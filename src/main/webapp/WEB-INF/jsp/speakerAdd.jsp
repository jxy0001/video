    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-9">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="http://localhost:8080/video/selectSpeakerPage.do?page=0">主讲人管理</a></li>
                <li><a href="http://localhost:8080/video/selectByPage.do?page=0">课程管理</a></li>
            </ul>
            <p class="navbar-text navbar-right">
                <span>${admin.accounts}</span> <i class="glyphicon glyphicon-log-in" aria-hidden="true"></i>&nbsp;&nbsp;<a href="http://localhost:8080/video/exit.do" class="navbar-link">退出</a>
            </p>
        </div>
...
<div class="container" style="margin-top: 20px;">
    ...
    <form id="infoForm" class="form-horizontal"  method="post" action="http://localhost:8080/video/addSpeaker">


        <div class="form-group">
            <label for="speakerName" class="col-sm-2 control-label">姓名</label>
            <div class="col-sm-10">
                <input class="form-control" name="speakerName" id="speakerName" placeholder="姓名" type="text">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="form-control" name="picUrl" id="picUrl" placeholder="头像地址" type="text">
            </div>
        </div>
        <div class="form-group">
            <label for="speakerDesc" class="col-sm-2 control-label">简介</label>
            <div class="col-sm-10">
                <textarea class="form-control" id="speakerDesc" name="speakerDesc" placeholder="主讲人简介" rows="3"></textarea>
            </div>
        </div>
        <div class="form-group">
