...
$('#loginu_open').click(function () {
    $('#loginu').removeClass('hidden');
});
$('#reg_close').click(function(){
    $('#reg').addClass('hidden');
});
$('#loginu_close').click(function(){
    $('#loginu').addClass('hidden');
});

$('#logina_open').click(function () {
    $('#logina').removeClass('hidden');
});
$('#logina_close').click(function(){
    $('#logina').addClass('hidden');
});
